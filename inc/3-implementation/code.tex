...
\todo{Should remove comments and maybe some code from these listings if they are not in the appendix.}
\lstinputlisting[language={Solidity}, caption={Lottery master contract}, label={lst:LotteryMaster.sol}]{listings/LotteryMaster.sol}
\lstinputlisting[language={Solidity}, caption={Lottery abstract match contract}, label={lst:AbstractLotteryMatch.sol}]{listings/AbstractLotteryMatch.sol}
