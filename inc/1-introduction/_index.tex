...
Our hypothesis will focus on the lottery aspect alone, although it is expected that the underlying blockchain will have consequences for the properties of the lottery.
\newline
\textbf{H\textsubscript{1}:} Can a fair digital coin toss tournament lottery be implemented on the Ethereum blockchain.
\newline
\textbf{H\textsubscript{0}:} It's unknown whether a fair digital coin toss tournament lottery be implemented on the Ethereum blockchain.
...
Both the Scopus and Webofscience databases were queried, but the relevant hits from Webofscience were a strict subset of the relevant hits from Scopus.
...
Data for gas price, ether price, and transaction throughput on the Ethereum blockchain was gathered from \url{https://etherscan.com/} and \url{https://ethgasstation.info/}. 
