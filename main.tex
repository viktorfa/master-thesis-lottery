...
\input{custom-listing-highlighting.tex}
...
\input{inc/DaimData.tex} % this is the file which contains all the details about your thesis
\makefrontpages % make the frontpages
\input{inc/intro/_index.tex}
...
\appendix
\include{inc/full-listings}
\include{inc/simulation-data}
%\include{inc/rawdata}
